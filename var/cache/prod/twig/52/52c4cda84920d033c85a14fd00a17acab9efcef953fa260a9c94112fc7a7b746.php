...
class __TwigTemplate_bbc2475c46c6d07f2cdaae2f7fd14eb77e7ce0c570d3873c3783776b43e9150c extends \Twig\Template
{
    ...
    ";
            ...
            if (((isset($context["profiler_markup_version"]) ? $context["profiler_markup_version"] : null) == 1)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                    ...
                    echo "</b>
                        <span>";
                    // line 27
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messageCount", [0 => $context["name"]], "method"), "html", null, true);
                    echo "</span>
                    </div>
                    <div class=\"sf-toolbar-info-piece\">
                        ...
                        <span>";
                    // line 31
                    echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "isSpool", [0 => $context["name"]], "method")) ? ("yes") : ("no"));
                    echo "</span>
                    </div>
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                    ...
                    echo "</span>
                        &nbsp; (<small>";
                    // line 43
                    echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "isSpool", [0 => $context["name"]], "method")) ? ("spooled") : ("sent"));
                    echo "</small>)
                    </div>
                ";
                }
        ...
        ";
            // line 49
            echo twig_include($this->env, $context, "@WebProfiler/Profiler/toolbar_item.html.twig", ["link" => (isset($context["profiler_url"]) ? $context["profiler_url"] : null)]);
            echo "
    ";
        }
    }
    ...
    <span class=\"label ";
        // line 56
        echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messageCount", [])) ? ("") : ("disabled"));
        echo "\">
        ";
        // line 57
        if (((isset($context["profiler_markup_version"]) ? $context["profiler_markup_version"] : null) == 1)) {
        ...
        ";
        // line 64
        if (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messageCount", []) > 0)) {
            // line 65
...
";
    ...
    ";
        // line 89
        if ( !$this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "mailers", [])) {
            // line 90
    ...
    ";
        // line 95
        if ((((isset($context["profiler_markup_version"]) ? $context["profiler_markup_version"] : null) == 1) || (twig_length_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "mailers", [])) > 1))) {
            // line 96
            echo "        <table>
            <thead>
                <tr>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                echo "</td>
                        <td class=\"font-normal\">";
                // line 111
                echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "isDefaultMailer", [0 => $context["name"]], "method")) ? ("This is the default mailer") : (""));
                echo "</td>
                    </tr>
                ";
            }
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "isSpool", [0 => $context["name"]], "method")) ? ("spooled") : ("sent"));
                echo " ";
                echo ((($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messageCount", [0 => $context["name"]], "method") == 1)) ? ("message") : ("messages"));
                echo "</span>
                </div>
            ";
            }
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
            // line 128
            echo "        ";
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "mailers", [])) > 1)) {
                // line 129
                echo "            <h3>
                ";
                // line 130
                ...
                <small>";
                // line 131
                echo (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "isDefaultMailer", [0 => $context["name"]], "method")) ? ("(default app mailer)") : (""));
                echo "</small>
            </h3>
        ";
            }
        ...
        ";
            // line 135
            if ( !$this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messages", [0 => $context["name"]], "method")) {
                // line 136
                echo "            <div class=\"empty\">
                <p>No e-mail messages were sent.</p>
            </div>
        ";
                ...
                echo "            ";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "messages", [0 => $context["name"]], "method"));
                $context['loop'] = [
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
                ...
                <div class=\"card\">
                    ...
                    ";
                    // line 179
                    $context["attachments"] = $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "extractAttachments", [0 => $context["message"]], "method");
                    // line 180
                    echo "                    ";
    ...
    {
        return new Source("", "@Swiftmailer/Collector/swiftmailer.html.twig", "C:\\wamp64\\www\\piDevEvents\\vendor\\symfony\\swiftmailer-bundle\\Resources\\views\\Collector\\swiftmailer.html.twig");
    }
}
