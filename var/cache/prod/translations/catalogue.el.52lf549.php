...
',
  ...
  'EasyAdminBundle' => 
  array (
    'new.page_title' => 'Δημιουργία %entity_name%',
    'show.page_title' => '%entity_name% (#%entity_id%)',
    'edit.page_title' => 'Επεξεργασία %entity_name% (#%entity_id%)',
    ...
    'toggle_navigation' => 'Άνοιγμα/Κλείσιμο πλοήγησης',
    ...
    'action.add_another_item' => 'Προσθήκη αντικειμένου',
  ...
  'messages' => 
  array (
    'action.new' => 'Δημιουργία %entity_name%',
