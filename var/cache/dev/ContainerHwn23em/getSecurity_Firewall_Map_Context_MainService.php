...
return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 3 => ${($_ = isset($this->services['security.authentication.listener.basic.main']) ? $this->services['security.authentication.listener.basic.main'] : $this->load('getSecurity_Authentication_Listener_Basic_MainService.php')) && false ?: '_'};
